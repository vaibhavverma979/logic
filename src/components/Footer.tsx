        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              <a href="https://www.facebook.com/vaibhav.verma.507057/friends" className="p-2 bg-white/20 rounded-full hover:bg-white/30 transition-colors">
                <Facebook className="h-4 w-4" />
              </a>
              <a href="#" className="p-2 bg-white/20 rounded-full hover:bg-white/30 transition-colors">
                <Twitter className="h-4 w-4" />
              </a>
              <a href="https://www.linkedin.com/in/vaibhav-verma-894001299?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="p-2 bg-white/20 rounded-full hover:bg-white/30 transition-colors">
                <Linkedin className="h-4 w-4" />
              </a>
              <a href="https://www.instagram.com/vaibhavexe._?igsh=YnhpZXkxeXVreTB6" className="p-2 bg-white/20 rounded-full hover:bg-white/30 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/80">Biet<br />Jhansi Uttar Pradesh 284128</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-white/80" />
                <span className="text-white/80">+919335733070</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-4 w-4 text-white/80" />
                <span className="text-white/80">vvaibhav247@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
